<template>
  <div class="contai">
    ...
    <p style="font-family: Arial; font-size: 15px" align="right">
      <strong>DIRECCI&Oacute;N DE CARRERA </strong>
    </p>
    <p align="right" style="text-transform: uppercase; font-size: 15px">
      <strong
        >{{ detalleActa.relacion_estudiante.relacion_carrera.carreraNombre }}
      </strong>
    </p>
    <br />
    <p align="right" style="font-size: 15px">La Paz, {{ fechaActual }}</p>
    <p align="right" style="font-size: 15px">
      <strong
        >CITE: UTB.DIR.ING.COM No.{{ actaData.nroCartaDefensa }}/{{
    ...
    <p
      style="margin-top: 0pt; margin-bottom: 0pt; text-align: right; line-height: normal"
    >
      <span style="font-family: Arial; font-size: 11pt">&nbsp;</span>
    </p>
    <p style="margin-top: 0pt; margin-bottom: 0pt; line-height: normal">
    ...
    <p
      ...
      "
    >
      <span style="font-family: Arial; font-size: 11pt">Se&ntilde;or</span>
    </p>
    <p style="margin-top: 0pt; margin-bottom: 0pt; line-height: normal">
    ...
    >
      <span style="font-size: 11pt"
        ><strong><span style="font-family: Arial">DOCENTE </span></strong></span
      >
    </p>
    <p
      style="
      ...
      <span style="font-size: 11pt"
        ><strong
          ><span style="font-family: Arial"
            >&ldquo;UNIVERSIDAD TECNOLOGICA BOLIVIANA&rdquo;</span
          ></strong
        ></span
      >
    </p>
    ...
    >
      <span style="font-size: 11pt"
        ><u><span style="font-family: Arial">Presente.-</span></u></span
      >
    </p>
    <p style="margin-top: 0pt; margin-bottom: 0pt; line-height: normal">
      <span style="font-size: 11pt"
    ...
    <p
      ...
      "
    >
      <span style="font-family: Arial; font-size: 11pt">Licenciado:</span>
    </p>
    <p style="margin-top: 0pt; margin-bottom: 0pt; line-height: normal">
      <span style="font-family: Arial; font-size: 11pt">&nbsp;</span>
    </p>
    ...
    >
      <span style="font-size: 11pt"
        ><span style="font-family: Arial"
          >En virtud a la reglamentaci&oacute;n de la Universidad Tecnol&oacute;gica
          Boliviana, para la obtenci&oacute;n del t&iacute;tulo de Licenciatura de la
          Carrera de
          <span style="text-transform: capitalize"
            >{{ detalleActa.relacion_estudiante.relacion_carrera.carreraNombre }}
          </span>
          y en atenci&oacute;n a sus m&eacute;ritos, la Direcci&oacute;n de la Carrera ha
          nominado a su persona tribunal interno para la defensa de </span
        ><strong
          ><span style="font-family: Arial">{{ detalleActa.nroPanel }}</span></strong
        ><span style="font-family: Arial"> del </span
        ><strong
          ><span style="font-family: Arial; text-transform: capitalize"
            >Perfil de {{ detalleSol.relacion_modalidad.nombreModalidad }}</span
          ></strong
        ><span style="font-family: Arial"> denominado</span
        ><strong
          ><span style="font-family: Arial; text-transform: uppercase"
            >: {{ detalleActa.relacion_estudiante.esTituloProyecto }}.</span
          ></strong
        ><strong><span style="font-family: Arial">&nbsp; </span></strong>Presentado por la
        postulante {{ detalleActa.relacion_estudiante.esGenero }}
      ...
      >
      <span style="font-family: Arial; font-size: 11pt">
        realizarse el d&iacute;a {{ sDia }} {{ fechaNumero }} a hrs.{{ horaF }} por Google
        Meet.</span
      >
    </p>
    <p
    ...
    <p style="margin-top: 0pt; margin-bottom: 8pt; text-align: justify">
      <span style="font-family: Arial; font-size: 11pt"
        >Para tal efecto se adjunta el documento correspondiente para su revisi&oacute;n y
        consideraci&oacute;n.</span
      >
    </p>
    <p style="margin-top: 0pt; margin-bottom: 8pt; text-align: justify">
      <span style="font-family: Arial; font-size: 11pt"
        >Seguro de contar con la formalidad y puntualidad que le caracteriza, reciba un
        cordial saludo.</span
      >
    </p>
    ...
    <pre>
                                      <span style="font-style:normal;font-weight:normal; font-family: Vladimir Script; font-size: 13pt; ">Ing. Luis A. Copa Soto</span>
                                        <span style="font-style:normal;font-weight:normal; font-family: Calibri; font-size: 9pt">DIRECTOR DE CARRERA</span>
                                        <span style="font-style:normal;	font-weight:normal; font-family: Times New Roman; font-size: 8pt">Ingenieria Comercial U.T.B</span>                                                                                    
  </pre>
    <p style="margin-top: 0pt; margin-bottom: 8pt; text-align: center">
      <span style="font-family: Arial">&nbsp;</span>
    </p>
    ...
    <p style="margin-top: 0pt; margin-bottom: 0pt; line-height: normal; font-size: 8pt">
      <span style="font-family: Arial">Adj./Lo indicado</span>
    </p>
    <p style="margin-top: 0pt; margin-bottom: 0pt; line-height: normal; font-size: 8pt">
      <span style="font-family: Arial">c.c. archivo </span>
    </p>
    <p style="margin-top: 0pt; margin-bottom: 0pt; line-height: normal; font-size: 8pt">
      <span style="font-family: Arial">LACS/AJG</span>
    </p>
  </div>
</template>
<script>
